describe("splitLargeFrames", function () {
  ...
  it("Should split large text frames", function (done) {
    ...
    client.onConnect = function () {
      ...
      expect(spyWebSocketSend.calls.first().args[0].length).toEqual(client.maxWebSocketChunkSize);
  ...
  it("Should not split large binary messages", function (done) {
    ...
    client.onConnect = function () {
      ...
      expect(spyWebSocketSend.calls.first().args[0].length).not.toBeLessThan(20*1024);
    };
    client.activate();
  });
