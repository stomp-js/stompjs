  ...
  `;
    ...
    class Client {
        ...
        constructor(conf = {}) {
             ...
             */
            this._intendedState = exports.ActivationState.INACTIVE;
            /**
         ...
         */
        activate() {
            this._intendedState = exports.ActivationState.ACTIVE;
        ...
        async _connect() {
            ...
            this._stompHandler = new StompHandler(this, webSocket, {
                ...
                onWebSocketClose: evt => {
                    ...
                    else if (this._intendedState === exports.ActivationState.ACTIVE) {
