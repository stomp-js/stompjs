...
var Client = /** @class */ (function () {
    ...
    Client.prototype._transmit = function (command, headers, body) {
        if (body === void 0) { body = ''; }
        var out = Frame.marshall(command, headers, body, this.escapeHeaderValues);
    ...
    Client.prototype._connect = function () {
        ...
        this.ws.onmessage = function (evt) {
            ...
            var unmarshalledData = Frame.unmarshall(_this.partialData + data, _this.escapeHeaderValues);
