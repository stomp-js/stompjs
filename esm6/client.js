...
var Client = /** @class */ (function () {
    ...
    Client.prototype._transmit = function (command, headers, body) {
        if (body === void 0) { body = ''; }
        var out = Frame.marshall(command, headers, body, this._escapeHeaderValues);
        this.debug(">>> " + out);
    ...
    Client.prototype._connect = function () {
        ...
        this._webSocket.onmessage = function (evt) {
            ...
            var unmarshalledData = Frame.unmarshall(_this._partialData + data, _this._escapeHeaderValues);
        ...
        this._webSocket.onopen = function () {
            ...
            _this.connectHeaders["accept-version"] = Versions.supportedVersions();
